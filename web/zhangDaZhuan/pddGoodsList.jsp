    ...
    layui.use(['laydate', 'upload', 'layer', 'table', 'element', 'laypage'], function () {
        ...
        table.render({
            ...
            , cols: [[ //表头
                ...
                , {field: 'goods_code', width: 130, title: 'SKU商品编码', align: 'center'}
                ...
                , {field: 'purchase_restrictions', width: 90, title: '购买限制', align: 'center', }
                , {field: 'company', width: 90, title: '单位', align: 'center', }
